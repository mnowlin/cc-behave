...
One of the leading approaches to understand the attitude-behavior gap is the Value-Belief-Norm (VBN) framework [@sternValueBeliefNormTheorySupport1999]. In brief, the VBN posits that underlining values inform broad environmental beliefs that activate norms that in turn support pro-environmental behavior. VBN involves a sequential chain that goes from values to beliefs to behavior. Additional work has examined the importance of belief systems, as developed by policy scholar using the Advocacy Coalition Framework []. 
...
To further elaborate the attitude-behavior model we examine the relationship between cultural cognition, environmental orientation (attitude and emotional connection), and behavior. The cultural worldviews measured by cultural cognition have been shown to shape views about climate change [@kahanPolarizingImpactScience2012] as well as environmental orientation, as measured by the New Ecological Paradigm [@nowlinEnvironmentalPolicymakingEra2019]; however, cultural cognition does not have a strong association with pro-environmental behaviors [@sparksMeasuringEnvironmentalValues2021]. In this paper, we examine whether environmental orientations mediate the relationship between cultural cognition and behavior such that cultural cognition shapes environmental orientations, which in turn influences pro-environmental behavior. In doing so, we argue that when cultural cognition aligns with environmental orientation, there is a stronger relationship with pro-environmental behaviors than when considering attitude or affect alone, thus reducing the attitude-behavior gap.
...
# Beliefs and Pro-Environmental Behavior
